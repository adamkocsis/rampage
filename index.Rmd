...
Consider this coarsened version of the [ETOPO topographic relief model](https://www.ncei.noaa.gov/products/etopo-global-relief-model) (0.25x0.25 degree resolution of the cell-registerd version of ETOPO1), using the widely-used extension package `terra`. 
...
# plotting
png("man/figures/etopo.png", width=1200,height=600)
