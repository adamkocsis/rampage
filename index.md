...
with the
[`rampage::expand`](https://adamtkocsis.com/rampage/reference/expand.md)
function. The resulting object can be used to control
[`fields::imagePlot`](https://rdrr.io/pkg/fields/man/imagePlot.html) via
its `breaks` argument:
...
![](reference/figures/fields_ramped.png)
